...
public class Requirement {
	...
	private Companysite companysite;// 工作地点
	...
	public Requirement(Long id, Integer addtype, Date formdate, Department department, Companysite companysite,
			String suggestsalary, String positionname, Integer addreason, Date arrivaldate, Integer addcount,
